...
function () {
  function Base(options) {
    ...
    getVM$1().set(this, '_listeners', {}); // Event listeners

    getVM$1().set(this, '_options', {}); // Internal option store
  ...
  _createClass(Base, [{
    ...
    value: function setOptions() {
      ...
      getVM$1().set(this, '_options', defaultsDeep_1.apply(void 0, [{}].concat(options, [// Given options
...
Base$1.REQUEST_CONTINUE = REQUEST_CONTINUE;
Base$1.REQUEST_REDUNDANT = REQUEST_REDUNDANT;
Base$1.REQUEST_SKIP = REQUEST_SKIP;
...
function (_Base) {
  ...
  function Collection() {
    ...
    getVM().set(_assertThisInitialized(_this), 'models', []); // Model store.

    getVM().set(_assertThisInitialized(_this), '_attributes', {}); // Property store.

    getVM().set(_assertThisInitialized(_this), '_registry', {}); // Model registry.

    getVM().set(_assertThisInitialized(_this), '_page', NO_PAGE);
  ...
  _createClass(Collection, [{
    ...
    value: function clearModels() {
      ...
      getVM().set(this, 'models', []); // Notify each model that it has been removed from this collection.
    ...
    value: function _removeModelAtIndex(index) {
      ...
      getVM()["delete"](this.models, index);
      this.onRemove(model);
      return model;
    }
    /**
    ...
    value: function sort(comparator) {
      getVM().set(this, 'models', sortBy_1(this.models, comparator));
    }
    /**
    ...
    value: function applyValidationErrorArray(errors) {
      ...
      each(models, function (model, index) {
        ...
        getVM().set(model, 'saving', false);
        getVM().set(model, 'fatal', false);
      });
    }
    /**
    ...
    value: function page(_page) {
      ...
      if (isNil_1(_page)) {
        getVM().set(this, '_page', NO_PAGE); // Page was provided, so we should either set the page or disable
        // pagination entirely if the page is `false`.
      } else {
        getVM().set(this, '_page', max_1([1, toSafeInteger_1(_page)]));
      }
    ...
    value: function applyPagination(models) {
      ...
      if (isEmpty_1(models)) {
        getVM().set(this, '_page', LAST_PAGE); // Otherwise, there were at least one model, and we can safely
        // assume that we want to increment the page number.
      } else {
        getVM().set(this, '_page', this._page + 1);
        this.add(models);
      }
    }
    /**
    ...
    value: function onDelete() {
      ...
      return Promise.all(this.models.map(function (m) {
        ...
        getVM().set(_this6, 'deleting', true);
        return Base.REQUEST_CONTINUE;
      });
    }
    /**
...
function (_Base) {
  ...
  function Model() {
    ...
    getVM$1().set(_assertThisInitialized(_this), '_collections', {}); // Collections that contain this model.

    getVM$1().set(_assertThisInitialized(_this), '_reference', {}); // Saved attribute state.

    getVM$1().set(_assertThisInitialized(_this), '_attributes', {}); // Active attribute state.

    getVM$1().set(_assertThisInitialized(_this), '_mutations', {}); // Mutator cache.

    getVM$1().set(_assertThisInitialized(_this), '_errors', {}); // Validation errors.
  ...
  _createClass(Model, [{
    ...
    value: function clone() {
      ...
      getVM$1().set(clone, '_reference', reference);
      getVM$1().set(clone, '_attributes', attributes);
      return clone;
    }
    /**
    ...
    value: function registerCollection(collection) {
      ...
      getVM$1().set(this._collections, collection._uid, collection);
    }
    /**
    ...
    value: function unregisterCollection(collection) {
      ...
      getVM$1()["delete"](this._collections, collection._uid);
    }
    /**
    ...
    value: function clearAttributes() {
      ...
      getVM$1().set(this, '_attributes', cloneDeep_1(defaults));
      getVM$1().set(this, '_reference', cloneDeep_1(defaults));
    }
    /**
     * Reverts all attributes back to their defaults, and completely removes all
     * attributes that don't have defaults. This will also sync the reference
    ...
    key: "clearState",
    value: function clearState() {
      getVM$1().set(this, 'loading', false);
      getVM$1().set(this, 'saving', false);
      getVM$1().set(this, 'deleting', false);
      getVM$1().set(this, 'fatal', false);
    }
    /**
    ...
    value: function mutate(attribute) {
      ...
      if (isUndefined_1(attribute)) {
        each(this._attributes, function (value, attribute) {
          getVM$1().set(_this3._attributes, attribute, _this3.mutated(attribute, value));
        ...
        each(castArray_1(attribute), function (attribute) {
          ...
          getVM$1().set(_this3._attributes, attribute, mutated);
        });
      }
    }
    /**
    ...
    value: function sync(attribute) {
      ...
      if (isUndefined_1(attribute)) {
        getVM$1().set(this, '_reference', active);
      } else {
        each(castArray_1(attribute), function (attribute) {
          getVM$1().set(_this4._reference, attribute, get_1(active, attribute));
        });
      }
    ...
    value: function set(attribute, value) {
      ...
      getVM$1().set(this._attributes, attribute, value); // Only consider a change if the attribute was already defined.
    ...
    value: function unset(attribute) {
      ...
      each(castArray_1(attributes), function (attribute) {
        if (_this7.has(attribute)) {
          getVM$1().set(_this7._attributes, attribute, get_1(defaults, attribute));
        }
      });
    }
    /**
    ...
    value: function setAttributeErrors(attribute, errors) {
      if (isEmpty_1(errors)) {
        getVM$1()["delete"](this._errors, attribute);
      } else {
        getVM$1().set(this._errors, attribute, castArray_1(errors));
      }
    }
    /**
    ...
    value: function onSaveSuccess(response) {
      ...
      getVM$1().set(this, 'saving', false);
      getVM$1().set(this, 'fatal', false); // Automatically add to all registered collections.
    ...
    value: function onFetch() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (_this14.loading) {
          return resolve(Base$1.REQUEST_SKIP);
        }

        getVM$1().set(_this14, 'loading', true);
        return resolve(Base$1.REQUEST_CONTINUE);
      });
    }
    /**
    ...
    value: function onSave() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        // This prevents things like accidental double-clicks.
        if (_this15.saving) {
          resolve(Base$1.REQUEST_SKIP);
          return;
        } // Don't save if no data has changed, but consider it a success.


        if (!_this15.getOption('saveUnchanged') && !_this15.changed()) {
          resolve(Base$1.REQUEST_REDUNDANT);
          return;
        }

        getVM$1().set(_this15, 'saving', true); // Mutate attribute before we save if required to do so.
        ...
        _this15.validate().then(function (errors) {
          if (isEmpty_1(errors)) {
            resolve(Base$1.REQUEST_CONTINUE);
            return;
          }

          getVM$1().set(_this15, 'saving', false);
    ...
    value: function onDelete() {
      ...
      if (this.deleting) {
        return Promise.resolve(Base$1.REQUEST_SKIP);
      }

      return new Promise(function (resolve, reject) {
        getVM$1().set(_this16, 'deleting', true);
        resolve(Base$1.REQUEST_CONTINUE);
      });
    }
  }]);
...
export { Collection, Model, Request, RequestError, Response };
